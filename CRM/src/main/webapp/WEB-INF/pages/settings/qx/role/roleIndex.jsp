		...
		<table class="table table-hover">
			...
			<tbody>
				<tr class="active">
					<td><input type="checkbox" /></td>
					<td>1</td>
					<td><a href="roleDetail.jsp" style="text-decoration: none;">001</a></td>
					<td>管理员</td>
				...
				<tr>
					<td><input type="checkbox" /></td>
					<td>2</td>
					<td><a href="roleDetail.jsp" style="text-decoration: none;">002</a></td>
					<td>销售总监</td>
				...
				<tr class="active">
					<td><input type="checkbox" /></td>
					<td>3</td>
					<td><a href="roleDetail.jsp" style="text-decoration: none;">003</a></td>
					<td>市场总监</td>
